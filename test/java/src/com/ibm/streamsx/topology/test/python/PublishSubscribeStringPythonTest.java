...
public class PublishSubscribeStringPythonTest extends PublishSubscribePython {
    ...
    public void testPublishStringMap() throws Exception {
    	...
    	includePythonApp(t, "string_map_string.py", "string_map_string.py::str_map_str");
    ...
    public void testPublishStringFilter() throws Exception {
    	...
    	includePythonApp(t, "string_filter_string.py", "string_filter_string.py::str_filter_str");
    ...
    public void testPublishStringFlatMap() throws Exception {
    	...
    	includePythonApp(t, "string_flatmap_string.py", "string_flatmap_string.py::str_flatmap_str");
