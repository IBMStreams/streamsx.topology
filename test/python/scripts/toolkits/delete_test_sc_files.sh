...
# Delete generated info.xml files for the toolkits located in /scripts/toolkits/
...
# Delete generated toolkit.xml files for the toolkits located in /scripts/toolkits/
find ${PARENT_PATH} -name toolkit.xml | xargs rm

# Delete generated samplemain folder, located in /scripts/apps/
find ${PARENT_PATH}/../apps/ -type d -name samplemain | xargs rm -r

# Delete generated info.xml files for the apps, located in /scripts/apps/
