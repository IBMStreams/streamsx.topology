...
class TestTopologyMethods(unittest.TestCase):
  ...
  def test_TopologySourceAndSink(self):
     ...
     hw.for_each(test_functions.check_hello_world)
  ...
  def test_TopologyLengthFilter(self):
     ...
     hwf.for_each(test_functions.check_strings_length_filter)
     standalone(self, topo)
  ...
  def test_TopologyIsolate(self):
     ...
     hw = topo.source(test_functions.hello_world)
     iso = hw.isolate()
     iso.for_each(test_functions.check_hello_world)
     standalone(self, topo)
  ...
  def test_TopologyIsolatedFilter(self):
     ...
     iso2 = hwf.isolate()
     iso2.for_each(test_functions.check_hello_world_filter)
     standalone(self, topo)
  ...
  def test_TopologyLowLatency(self):
     ...
     hwf3.for_each(test_functions.check_hello_world_filter)
     standalone(self, topo)
     streamsx.topology.context.submit("BUNDLE", topo.graph)
  ...
  def test_TopologyTransform(self):
     ...
     i2.for_each(test_functions.check_int_strings_transform)
     standalone(self, topo)
  ...
  def test_TopologyTransformWithDrop(self):
     ...
     i2 = i1.map(test_functions.add17)
     i2.for_each(test_functions.check_int_strings_transform_with_drop)
     standalone(self, topo)
  ...
  def test_TopologyMultiTransform(self):
      ...
      i1 = source.flat_map(test_functions.split_words)
      i1.for_each(test_functions.check_strings_multi_transform)
      standalone(self, topo)
  ...
  def test_TopologyTransformCallableAddWithDrop(self):
      ...
      source = topo.source(test_functions.int_strings_transform_with_drop)
      i1 = source.map(test_functions.string_to_int_except68)
      i2 = i1.map(test_functions.AddNum(17))
      i2.for_each(test_functions.check_int_strings_transform_with_drop)
      standalone(self, topo)
  ...
  def test_TopologyMultiTransformCallableIncMaxSplit(self):
      ...
      i1.for_each(test_functions.check_strings_multi_transform_inc_max_split)
      standalone(self, topo)
  ...
  def test_TopologySourceAndSinkCallable(self):
      ...
      hw.for_each(test_functions.CheckTuples(["a0", "b1", "c2", "d3"]))
      standalone(self, topo)
  ...
  def test_TopologyParallel(self):
      ...
      hwef.for_each(test_functions.SeedSinkRR())
      standalone(self, topo)
  ...
  def test_TopologyUnion(self):
      ...
      hwu.for_each(test_functions.check_union_hello_world)
      standalone(self, topo)
  ...
  def test_TopologyParallelUnion(self):
      ...
      hwp = hw.parallel(4)
      hwf = hwp.map(test_functions.ProgramedSeed())
      hwf2 = hwp.map(test_functions.ProgramedSeed())    
      streamSet = {hwf2}
      hwu = hwf.union(streamSet)
      hwup = hwu.end_parallel()
      hwup.for_each(test_functions.SeedSinkRRPU())
      standalone(self, topo)
  ...
  def test_TopologyImportPackage(self):
      ...
      try:
          ...
          hwf.for_each(test_package.test_subpackage.test_module.CheckTuples(["Hello"]))
          standalone(self, topo)
      finally:
          pass
  ...
  def test_TopologyImportNamespacePackage(self):
      ...
      try:
          ...
          hwf = hw.filter(test_functions.filter)
          hwf.for_each(test_ns_module.CheckTuples(["World!"]))
          standalone(self, topo)
      finally:
          del test_ns_module
  ...
  def test_TopologyImportCommonNamespacePackage(self):
      ...
      try:
          ...
          hwf.for_each(common_namespace.module2.CheckTuples(["World!"]))
          standalone(self, topo)
      finally:
          for p in tcn_paths:
              sys.path.remove(p)
  ...
  def test_TopologyImportModuleWithDependencies(self):
      ...
      try:
          ...
          hwf.for_each(test_functions2.check_hello_world_filter)
          standalone(self, topo)
      finally:
          del test_functions2
