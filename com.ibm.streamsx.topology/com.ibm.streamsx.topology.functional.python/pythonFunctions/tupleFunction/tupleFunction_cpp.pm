...
sub main::generate($$) {
   ...
   print '  ss.str("");', "\n";
   print "\n";
   print '  // Get a reference to a transformation function object', "\n";
   ...
   print "\n";
   print '  ss<<"functionFactory.getFunction(functionTypes.TUPLE_FUNCTION, \\""<<serializedFunc<<"\\",\\""<<functionName<<"\\", \\""<<functionLocation<<"\\")";', "\n";
   print "\n";
   print '  // Obtain the reference', "\n";
   print '  tupleFunction = PyRun_String(ss.str().c_str(), Py_eval_input, globalDictionary, localDictionary);', "\n";
   print '  if(tupleFunction == NULL){', "\n";
   print '      PyErr_Print();', "\n";
   print '      throw;', "\n";
   print '  }', "\n";
   print "\n";
   ...
   print "\n";
   print '  // Might need to decref later', "\n";
   print '  PyObject * pyReturnVar = PyObject_CallObject(tupleFunction, pyTuple);', "\n";
   print "\n";
