...
sub main::generate($$) {
   ...
   print "\n";
   print "\n";
   SPL::CodeGenHelper::implementationPrologueImpl($model,0,10);
   print "\n";
   print '// Constructor', "\n";
   ...
   print '  ss.str("");', "\n";
   print "\n";
   print '  // Get a reference to a sink function object', "\n";
   ...
   print "\n";
   print '  ss<<"functionFactory.getFunction(functionTypes.SINK_FUNCTION, \\""<<serializedFunc<<"\\",\\""<<functionName<<"\\", \\""<<functionLocation<<"\\")";', "\n";
   print "\n";
   print '  // Obtain the reference', "\n";
   print '  sinkFunction = PyRun_String(ss.str().c_str(), Py_eval_input, globalDictionary, localDictionary);', "\n";
   print '  if(sinkFunction == NULL){', "\n";
   print '      PyErr_Print();', "\n";
   print '      throw;', "\n";
   print '  }', "\n";
   print "\n";
   print '  PyGILState_Release(gstate);', "\n";
   print '  SPLAPPTRC(L_INFO, "Finished initialization of python operator", "python");', "\n";
   print '}', "\n";
   print "\n";
   print '// Destructor', "\n";
   print 'MY_OPERATOR_SCOPE::MY_OPERATOR::~MY_OPERATOR() ', "\n";
   ...
   print '{', "\n";
   print '  IPort0Type &ip = static_cast<IPort0Type &>(tuple);', "\n";
   print '  SPL::blob pyblob = ip.get___splpy_o();', "\n";
   print '  long int sizeb = pyblob.getSize();', "\n";
   print '  const unsigned char * pybytes = pyblob.getData();', "\n";
   print "\n";
   print '  PyGILState_STATE gstate;', "\n";
   print '  gstate = PyGILState_Ensure();', "\n";
   print "\n";
   print '  // Might need to decref later', "\n";
   print '  PyObject * pyBytes  = PyBytes_FromStringAndSize((const char *)pybytes, sizeb);', "\n";
   print '  PyObject * pyTuple = PyTuple_New(1);', "\n";
   print "\n";
   print '  PyTuple_SetItem(pyTuple, 0, pyBytes);', "\n";
   print "\n";
   print '  // Might need to decref later', "\n";
   print '  PyObject * pyReturnVar = PyObject_CallObject(sinkFunction, pyTuple);', "\n";
   print "\n";
   print '  if(pyReturnVar == 0){', "\n";
   print '    PyErr_Print();', "\n";
   print '    throw;', "\n";
   print '  }', "\n";
   print "\n";
