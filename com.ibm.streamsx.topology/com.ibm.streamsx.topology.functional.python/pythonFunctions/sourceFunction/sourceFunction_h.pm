...
sub main::generate($$) {
   ...
   print "\n";
   SPL::CodeGenHelper::headerPrologueImpl($model,0,undef,4);
   print "\n";
   ...
   print "\n";
   print 'private:', "\n";
   print '  void simpleStringCatchErr(const char * str);', "\n";
   print '  PyObject* sourceFunction;', "\n";
   print "\n";
   print '}; ', "\n";
   print "\n";
